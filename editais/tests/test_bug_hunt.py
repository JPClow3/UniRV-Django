...
from editais.utils import (
    ...
    sanitize_html,
    sanitize_edital_fields,
    mark_edital_fields_safe,
        ...
        if form2.is_valid():
            try:
                ...
                if isinstance(e, dict):
                    ...
                    self.assertTrue(
                        "email" in error_str
                        or "e-mail" in error_str
                        or "cadastrado" in error_str
                    )
        else:
...
class EdgeCaseTests(TestCase):
    ...
    def test_url_redirect_with_missing_slug(self):
        ...
        edital = Edital.objects.create(
            titulo="Test Edital", url="https://example.com", slug=None  # No slug
        )
...
class ValidationTests(TestCase):
    ...
    def test_url_field_validation(self):
        ...
        for url in invalid_urls:
            try:
                edital = Edital(titulo="Test", url=url, created_by=self.user)
