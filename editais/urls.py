...
from . import views
from .autocomplete import TagAutocomplete, EditalAutocomplete
...
urlpatterns = [
    ...
    path(
        ...
        views.dashboard_novo_edital,
        name="dashboard_novo_edital",
    ),
    path("dashboard/startups/", views.dashboard_startups, name="dashboard_startups"),
    path(
        "dashboard/startups/submeter/",
        views.dashboard_submeter_startup,
        name="dashboard_submeter_startup",
    ),
    path(
        "dashboard/startups/<int:pk>/editar/",
        views.dashboard_startup_update,
        name="dashboard_startup_update",
    ),
    # Redirect legacy /dashboard/projetos/ URLs to /dashboard/startups/
    path(
        "dashboard/projetos/",
        RedirectView.as_view(pattern_name="dashboard_startups", permanent=True),
    ),
    path(
        "dashboard/projetos/submeter/",
        RedirectView.as_view(pattern_name="dashboard_submeter_startup", permanent=True),
    ),
