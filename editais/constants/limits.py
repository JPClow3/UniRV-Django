...
__all__ = [
    ...
    'SLUG_GENERATION_MAX_ATTEMPTS_PROJECT',  # Deprecated: use SLUG_GENERATION_MAX_ATTEMPTS_STARTUP
    'RATE_LIMIT_REQUESTS',
    'RATE_LIMIT_WINDOW',
...
SLUG_GENERATION_MAX_ATTEMPTS_STARTUP = 100
# Backward compatibility alias (deprecated - use SLUG_GENERATION_MAX_ATTEMPTS_STARTUP)
SLUG_GENERATION_MAX_ATTEMPTS_PROJECT = SLUG_GENERATION_MAX_ATTEMPTS_STARTUP
...
# File upload limits
MAX_LOGO_FILE_SIZE = 5 * 1024 * 1024  # 5MB in bytes
